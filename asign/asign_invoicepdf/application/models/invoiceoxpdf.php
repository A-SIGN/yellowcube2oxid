...
$sTcPdfPath = $myConfig->getModulesDir() . "asign/asign_invoicepdf/lib/tcpdf/";
$sTcPdfUrl  = $myConfig->getConfigParam( 'sShopURL') . "/" . $myConfig->getModulesDir() . "asign/asign_invoicepdf/lib/tcpdf/";
 ...
 * @package core
 */
class InvoiceOxpdf extends TCPDF
{
    /**
